package com.pervll.creator.world.level;
...
public class GodArrowExplosion extends Explosion {
            ...
            if (!entity.ignoreExplosion()) {
                ...
                if (d12 <= 1.0D) {
                    ...
                    if (d13 != 0.0D) {
                        ...
                        entity.hurt(this.getDamageSource(), (float)((int)(((d10 * d10 + d10)+this.addDamage) / 2.0D * 7.0D * (double)f2 + 1.0D)));
                        double d11 = d10;
